...
const Popup = ({ items, active, toggleModal, handleNoThanks }) => {
  ...
  return (
    <div className={`reveal-overlay`} style={{ display: active ? 'block' : 'none' }}>
      <div
      ...
      >
        ...
        <div className='modal-header grid-y align-center-middle'>
          ...
          <h5 className='section__heading' style={{ marginBottom: '1rem', textTransform: 'none' }}>
            $5.00 each
          </h5>
          <button onClick={handleNoThanks} type='button' className='pagination__item'>
            No Thanks
          </button>
        </div>
